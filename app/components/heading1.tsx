    ...
    return (
        <div className={`flex ${center ? 'justify-center text-center' : ''}`}>
            <div className="py-4 md:py-10">
                <div className={`text-xl md:text-3xl 2xl:text-4xl uppercase font-bold mb-2 ${white ? 'text-white' : 'text-blue-800'}`} data-aos="fade-up" data-aos-duration="1000">{title}</div>
