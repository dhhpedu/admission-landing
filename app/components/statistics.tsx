...
const Statistics: React.FC = () => {
    return (
        <div className="flex gap-2 md:gap-4 md:gap-10 2xl:gap-40 justify-center py-4 md:py-8 rounded md:rounded-lg bg-cover px-2 md:px-0" style={{
            backgroundImage: 'url(	https://w.ladicdn.com/s1550x650/5c7362c6c417ab07e5196b05/20-20240130173313-k02ok.png)'
        }} data-aos="fade-up" data-aos-duration="1000">
            <div className="h-32 md:h-48 w-48 bg-white rounded-full flex items-center justify-center flex-col p-4 text-center border-8 border-orange-600 shadow-lg">
                ...
                <div className="text-xs md:text-sm hidden md:block">Sinh viên đã và đang theo học</div>
            </div>
            <div className="h-32 md:h-48 w-48 bg-white rounded-full flex items-center justify-center flex-col p-4 text-center border-8 border-orange-600 shadow-lg">
